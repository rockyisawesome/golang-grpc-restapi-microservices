...
const (
	HelloWorld_GetHello_FullMethodName = "/HelloWorld/GetHello"
)
...
type HelloWorldClient interface {
	...
	GetHello(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*HelloResponse, error)
}
...
func (c *helloWorldClient) GetHello(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*HelloResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, HelloWorld_GetHello_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloWorldServer interface {
	// Hello world greeting
	GetHello(context.Context, *EmptyMessage) (*HelloResponse, error)
...
func (UnimplementedHelloWorldServer) GetHello(context.Context, *EmptyMessage) (*HelloResponse, error) {
...
func _HelloWorld_GetHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HelloWorld_GetHello_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldServer).GetHello(ctx, req.(*EmptyMessage))
	}
